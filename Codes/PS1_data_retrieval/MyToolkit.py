...
def plot_sky_map_ps1(ra, dec, title = "Default title"):
    ...
    gal_line_equat_1 = gal_line_1.transform_to('icrs')   ### gal_line_equat is the galactic line in equatorial coordinates
    ...
    plt.scatter(ra, dec, marker = 'o', color = 'red', s = 6)
    plt.title(title)
    plt.grid(True)
